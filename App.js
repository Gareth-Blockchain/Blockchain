...
import Tender from './artifacts/contracts/GovProj.sol/GovProj.json'
...
function App() {
  ...
  const [pIndex, getProposalIndex] = useState()
  ...
  async function fetchNumVoters() {
    if (typeof window.ethereum !== 'undefined') {
      ...
      const contract = new ethers.Contract(tenderAddress, Tender.abi, provider)
      try {
  ...
  async function registerVoter() {
    ...
    if (typeof window.ethereum !== 'undefined') {
      ...
      const contract = new ethers.Contract(tenderAddress, Tender.abi, signer)
  ...
  async function tallyVotes() {
    ...
    if (typeof window.ethereum !== 'undefined') {
      ...
      const contract = new ethers.Contract(tenderAddress, Tender.abi, provider)
      try {
        const talliedVotes = await contract.tallyVotes(pID)
